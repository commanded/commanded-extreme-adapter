defmodule Commanded.EventStore.Adapters.Extreme.AppendEventsTestCase do
  ...
  describe "append events to a stream" do
    ...
    @tag skip: ":no_stream parameter is not implemented yet"
    ...
    @tag skip: ":stream_exists parameter is not implemented yet"
