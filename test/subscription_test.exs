defmodule Commanded.EventStore.Adapters.Extreme.SubscriptionTest do
  use Commanded.EventStore.Adapters.Extreme.StorageCase

  defp event_store_wait(), do: 500
  ...
  describe "transient subscription to all streams" do
    @tag skip: "event_number implementation differs"
  ...
  describe "subscribe to single stream" do
    ...
    @tag skip: "persistent subscription to not a projection is not implemented"
  ...
  describe "unsubscribe from all streams" do
    @tag skip: "unsubscribe by PID is not implemented yet"
  ...
  describe "resume subscription" do
    test "should remember last seen event number when subscription resumes" do
      ...
      # @todo Update Commanded.EventStore.Subscriber.stop_subscriber/1
      # to wait for subscription to be stopped
